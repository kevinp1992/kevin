...
$sitename = "Filo Jobs";
$siteslogan = "The Ulimate Job Search Engine";
$sitedescription = $sitename .' finds all the latest jobs on all major job sites. Job search made simple with '.$sitename;
$sitekeywords = "job board, jobs, job search engine, find jobs, careers, employment, job listings, resume builder, resume post,job aggregator,rss jobs";
...
// CAROUSEL SLIDER
$slide1_title = "The Ulimate Job Search Engine";
$slide1_description = $sitename .' finds all the latest jobs on all major job sites. Job search made simple with '.$sitename;
$slide2_title = "Filo Jobs";
$slide2_description = "One search to find all job postings on Indeed, CareerJet, SimplyHired, MonsterBoard and more.";
$slide3_title = "Filo Jobs";
$slide3_description = "Browse jobs by Category or Location or Search Jobs in Realtime.";

// CONTACT & ABOUT
$contact_company_name = "Filo Directory";
$contact_email = "kevin.k.peter11@gmail.com";

$about_text= "<p>Filo Jobs is an all-in-one Job Search Engine for Every Country.</p><p>Find the latest Job listings posted on job banks, job search engine sites and job directories.</p>";
...
$strings['MENU_LANGUAGE'] = 'Locations';
